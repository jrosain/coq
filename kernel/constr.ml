...
let mkGhost u = of_kind @@ Sort (Sorts.ghost u)
...
let pr_puniverses p u =
  ...
  else Pp.(p ++ str"(*" ++ UVars.Instance.pr Quality.QVar.raw_pr Univ.Level.raw_pr u ++ str"*)")
...
let rec debug_print c =
  ...
  | Array(u,t,def,ty) -> str"Array(" ++ prlist_with_sep pr_comma debug_print (Array.to_list t) ++ str" | "
      ...
      ++ str")@{" ++ UVars.Instance.pr Quality.QVar.raw_pr Univ.Level.raw_pr u ++ str"}"
