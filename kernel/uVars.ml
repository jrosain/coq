...
struct
  ...
  let empty = (([||], [||]), (Instance.empty, PolyConstraints.empty))
  ...
  let union ((qna, una), (univs, csts)) ((qna', una'), (univs', csts')) =
    (Array.append qna qna', Array.append una una'), (Instance.append univs univs', PolyConstraints.union csts csts')
...
struct
  ...
  let empty = (([||],[||]), PolyConstraints.empty)
  ...
  let union ((qnas,unas), cst) ((qnas',unas'), cst') =
    ((Array.append qnas qnas', Array.append unas unas'), PolyConstraints.union cst cst')
