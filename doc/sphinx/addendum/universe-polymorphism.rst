...
.. insertprodn universe_name poly_constraint
...
.. prodn::
   ...
   | _
   | @qualid
   poly_decl ::= @%{ {? {* @ident } %| } {* @ident } {? + } {? %| {*, @poly_constraint } {? + } } %}
   cumul_poly_decl ::= @%{ {? {* @ident } %| } {* {? {| + | = | * } } @ident } {? + } {? %| {*, @poly_constraint } {? + } } %}
   poly_constraint ::= @test_univ_cst @universe_name {| < | = | <= } @universe_name
...
.. cmd:: Constraint {+, @poly_constraint }
