...
val build_scheme : (Names.lident * Libnames.qualid * Constrexpr.sort_name_expr) list -> unit
val build_case_scheme : Names.lident * Libnames.qualid * Constrexpr.sort_name_expr -> unit
