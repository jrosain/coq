...
val push_sort : visibility -> full_path -> Quality.QGlobal.t -> unit
...
val locate_quality : qualid -> Quality.QGlobal.t
...
val shortest_qualid_of_quality : ?loc:Loc.t -> 'u Id.Map.t -> Quality.QGlobal.t -> qualid
