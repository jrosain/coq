    ...
    match mib.mind_finite with
      ...
      | Finite when truly_recursive || nb_ind > 1 (* Hum... *) ->
         ...
         Array.init nb_ind (fun i ->
            ...
            if not (QGraph.is_allowed_elimination (Environ.qualities env) kelim Quality.qtype) then
      ...
      | Finite | BiFinite ->
         ...
         if not (QGraph.is_allowed_elimination (Environ.qualities env) kelim Quality.qtype)
