...
(** Command [Constraint]. *)
val do_constraint : poly:bool -> Constrexpr.level_constraint_expr list -> unit

val add_constraint_source : GlobRef.t -> PolyConstraints.ContextSet.t -> unit

val constraint_sources : unit -> (GlobRef.t * PolyConstraints.t) list
