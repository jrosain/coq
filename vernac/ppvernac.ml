...
let pr_polydecl_constraints elims univs extensible =
...
let pr_universe_decl l =
  ...
  | Some l ->
    ...
    pr_polydecl_constraints l.polydecl_elim_constraints l.polydecl_univ_constraints l.polydecl_extensible_constraints ++
    str "}"
